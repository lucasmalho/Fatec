...
CREATE POLICY "Allow laboratories to read client data"
ON users FOR SELECT
TO authenticated
USING (
  type = 'client' AND
...
CREATE POLICY "Allow clients to view own exams"
ON exams FOR SELECT
TO authenticated
USING (client_id = auth.uid());

CREATE POLICY "Allow laboratories to manage exams"
ON exams FOR ALL
TO authenticated
...
CREATE POLICY "Allow clients to view own appointments"
ON appointments FOR SELECT
TO authenticated
USING (client_id = auth.uid());

CREATE POLICY "Allow clients to create appointments"
ON appointments FOR INSERT
TO authenticated
WITH CHECK (client_id = auth.uid());

CREATE POLICY "Allow laboratories to manage appointments"
...
CREATE POLICY "Allow laboratories to upload documents"
...
CREATE POLICY "Allow access to own documents"
